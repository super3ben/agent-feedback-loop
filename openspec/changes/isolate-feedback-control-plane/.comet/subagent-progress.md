...
- Plan task: `Task 6 complete: 实现 macOS/Linux detached reviewer 与 prompt-time recovery`
...
- Task 6 base: `d16e051ded7ff2cc0c4e261c2ba24c6544f8d718`
...
- Next action: dispatch one TDD implementer for exactly `src/reviewer-launcher.mjs`, `test/reviewer-launcher.test.mjs` and `test/e2e-smoke.test.mjs`, then run one fresh frozen A-G review
