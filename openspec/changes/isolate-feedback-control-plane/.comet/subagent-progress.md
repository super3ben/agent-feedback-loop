...
- Next action: generate the Task 6 brief, freeze its launcher/recovery acceptance, then dispatch one TDD implementer for exactly `src/reviewer-launcher.mjs`, `test/reviewer-launcher.test.mjs` and `test/e2e-smoke.test.mjs`
